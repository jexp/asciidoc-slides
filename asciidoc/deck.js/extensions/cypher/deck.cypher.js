...
(function() {
  ...
  CodeMirror.defineMode("cypher", function(config) {
    ...
    keywords = wordRegexp(["start", "merge", "using", "on create", "on match", "match", "index", "on", "drop", "where", "with", "limit", "skip", "order", "by", "return", "create", "delete", "set", "remove", "unique", "optional"]);
    operatorChars = /[*+\-<>=&|~]/;
    return {
